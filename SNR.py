...
SIGNALR_ENDPOINT = "https://snr90.service.signalr.net"  # Replace with your SignalR service endpoint
SIGNALR_KEY = "CiGls0Lfg7olcRj26L2gaS6QFJMlbTQfPaGeJdczGfjz414qiOTFJQQJ99AKACYeBjFXJ3w3AAAAASRSmw9Y"  # Replace with your SignalR key
HUB_NAME = "chatHub"  # SignalR Hub name

# Function to calculate Signal-to-Noise Ratio (SNR)
def calculate_snr(signal, noise):
    if noise == 0:
        return float('inf')  # Infinite SNR if noise is 0
...
def send_message():
    ...
    # Broadcast message and SNR to Azure SignalR Service
